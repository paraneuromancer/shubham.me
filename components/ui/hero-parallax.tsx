    ...
    return (
        <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
            <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
                Hi there!<br /> I'm Shubham Pokale
            </h1>
            <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
                I am a Software Engineer with a passion for deep work and creative problem solving. You can read my writing or code, or follow me online. I also make videos, play games and advise. Reach out if interested

            </p>
            <br></br>                    These days, I'm a GATE Aspirant focused on cracking the GATE 2027 with a golden rank.
